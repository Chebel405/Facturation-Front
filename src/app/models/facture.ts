export class Facture {
    ...
    datePdf: Date;
    dateDeFinalisation: Date;
    dateEnvoi: Date;
    dateRelance: Date;
    datePaiement: Date;
    emetteurNom: String;
    emetteurSociete: String;
    emetteurSiren: String;
    emetteurSiret: String;
    emetteurCodeActivite: String;
    emetteurCodeApe: String;
    emetteurCodeTva: String;
    emetteurAdresse: String;
    emetteurTelephone: String;
    emetteurMail: String;
    destinationNom: String;
    destinationSociete: String;
    destinationSiren: String;
    destinationCodeActivite: String;
    destinationCodeApe: String;
    destinationCodeTva: String;
    destinataireAdresse: String;
    destinataireTelephone: String;
    destinataireMail: String;
    documentLie: String;
    tvaTexteDefault: String;
    conditionDePaiement: String;
    modeDePaiement: String;
    interetDeRetard: String;
    compteBancaire: String;
    ligneDetail: String;
    tva0TexteDefault: String;
    interetDeRetardTexteDefault: String;
    assuranceProTexteDefault: String;
    servicesTexteDefault: String;
  //  entreprise: Entreprise;
  
    constructor(numeroDeFacture: String,
      statut: String,
      dateDeCreation: Date,
      dateDeModification:Date,
      datePdf:Date,
      ...
      this.dateDeFinalisation =dateDeFinalisation ;
